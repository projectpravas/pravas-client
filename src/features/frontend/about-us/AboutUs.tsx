    ...
    <>
      ...
      >
        <Grid item xs={12} sm={12} md={6}>
          ...
          >
            <img
              src="https://pravasthejourney.com/wp-content/uploads/2022/06/RD_03845-HDR-scaled.jpg"
              width="100%"
              height="100%"
            />
          </Item>
          ...
          >
            ...
            <Typography
              sx={{
                color: "#FDF1C9",
                textAlign: "left",
                fontSize: { xs: "1.8rem", md: "1.2rem", lg: "1.3rem" },
                marginTop: "15px",
                marginBottom: "15px",
                lineHeight: 1.2,
                fontWeight: "500",
            ...
            >
              A MAN OF BONDING WITH TRAVELLING, HISTORY AND HERITAGE. Some
              people are crazy about travel, they always look for new places to
              move and make persistent plans. And Mr. Ajit is one among them who
              has planned 350+ tours and has completed around 250+ treks and
              explored many forts, heritage places through India. With every
              trip, he gained experience and came to know exactly what the
              tourists likes. His attachment, eagerness forced him to step in
              the travel business. And from past 10+ years he is planning some
              distinctive trips to destinations across the globe. That’s why his
              tours are exceptional and attract more travellers.
            </Typography>
          </Item>
        </Grid>
      </Grid>
